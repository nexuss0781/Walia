...
*   **The Magic:** You do not need to re-run your setup scripts. You can immediately modify a source variable, and the engine will use the **Archived Thunks** to update the entangled sinks perfectly. The logic never "died"—it was simply frozen.
